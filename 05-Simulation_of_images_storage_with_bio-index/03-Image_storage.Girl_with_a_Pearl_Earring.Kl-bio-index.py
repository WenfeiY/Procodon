"""
Encoding image of "Girl with a Pearl Earring" into yeast genome with bio-index from Kluyveromyces lactis
"""
...
#  Image file path
file_path = './Images/Girl_with_a_Pearl_Earring.jpg'
...
#  Load gene order from Kluyveromyces lactis
with open('Kl.bio-index.txt', 'r') as f:
...
with open('S.cerevisiae.Girl_with_a_Pearl_Earring.Kl-bio-index.json', 'w') as hd:
...
SeqIO.write(recoded_record_list, 'S.cerevisiae.Girl_with_a_Pearl_Earring.Kl-bio-index.gbk', 'genbank')

#  Convert Genbank file into FASTA
records = []
for record in SeqIO.parse('S.cerevisiae.Girl_with_a_Pearl_Earring.Kl-bio-index.gbk', 'genbank'):
    records.append(record)
    SeqIO.write(records, 'S.cerevisiae.Girl_with_a_Pearl_Earring.Kl-bio-index.fasta', 'fasta')
